<nav x-data="{ open: false }" class="bg-white border-b border-gray-100">
  ...
  <div class="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
    <div class="flex justify-between h-16">
      <div class="flex">
        ...
        <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
          <x-jet-nav-link href="{{ route('chores.index') }}" :active="request()->routeIs('chores.index')">
            {{ __('Chores') }}
          </x-jet-nav-link>
        </div>
      </div>
        ...
        <div class="relative ml-3">
          <x-jet-dropdown align="right" width="48">
            ...
            <x-slot name="content">
              ...
              <x-jet-dropdown-link href="{{ route('calendar_tokens.index') }}">
                {{ __('iCalendar Links') }}
              </x-jet-dropdown-link>
  ...
  <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
    ...
    <div class="pt-2 pb-3 space-y-1">
      <x-jet-responsive-nav-link href="{{ route('chores.index') }}" :active="request()->routeIs('chores.index')">
        {{ __('Chores') }}
      </x-jet-responsive-nav-link>
    </div>
    ...
    <div class="pt-4 pb-1 border-t border-gray-200">
      ...
      <div class="mt-3 space-y-1">
        ...
        <x-jet-responsive-nav-link href="{{ route('calendar_tokens.index') }}" :active="request()->routeIs('calendar_tokens.index')">
          {{ __('iCalendar Links') }}
        </x-jet-responsive-nav-link>
