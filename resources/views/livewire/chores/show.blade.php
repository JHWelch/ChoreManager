          ...
          <div class="md:flex md:items-center md:justify-between md:space-x-4 xl:border-b xl:pb-6">
            ...
            <div class="flex items-center mt-4 space-x-3 md:mt-0">
              <a
                ...
                class="inline-flex justify-center px-4 py-2 text-sm font-medium text-violet-700 bg-white border border-violet-300 rounded-md shadow-sm hover:bg-violet-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-900"
              >
                <x-icons.pencil class="w-5 h-5 mr-2 -ml-1 text-violet-400"/>
              ...
              <button
                ...
                class="inline-flex justify-center px-4 py-2 text-sm font-medium text-violet-700 bg-white border border-violet-300 rounded-md shadow-sm hover:bg-violet-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-violet-900"
              >
                <x-icons.check-circle class="w-5 h-5 mr-2 -ml-1 text-violet-400" />
